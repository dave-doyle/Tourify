...
public class WebSecurityConfig{
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000","http://34.244.182.238", "https://csi6220-2-vm1.ucd.ie","http://localhost","http://localhost:80","https://localhost:80","https://localhost:3000" ));
